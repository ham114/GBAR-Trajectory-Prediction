...
if __name__ == "__main__":
    ...
    pred_train = torch.load('/home/userdata/2024_hyn/dataset/nasa_dashlink/val.pt')
    data_flt = pred_train['raw_data']
    data_flt = data_flt.cpu().numpy()  # 转为 numpy
    N, L, C = data_flt.shape
    assert C == 12, "特征数必须为 12"
    ...
    torch.save(
        ...
        "/home/userdata/2024_hyn/dataset/nasa_dashlink/binary_val.pt"
    )
